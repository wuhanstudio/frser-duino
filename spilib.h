...
/* The usual duinos ... */
#ifndef CS_PIN
#define CS_PIN 10   // Arduino UNO default SS pin
#endif

// You must implement these somewhere (GPIO control)
#ifndef spi_select
#define spi_select()   digitalWrite(CS_PIN, LOW)
#define spi_deselect() digitalWrite(CS_PIN, HIGH)
#endif
